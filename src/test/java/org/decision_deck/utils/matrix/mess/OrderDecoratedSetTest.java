...
public class OrderDecoratedSetTest {
	...
	// ordered.setSubsetComparator(ExtensionalComparator.create(Arrays.asList("Before3", "After", "Ploum",
	// "Before2",
	// "Before1", "Final")));
	// assertTrue(Iterables.elementsEqual(Arrays.asList("Before1", "Before2", "Before3", "After", "Final"),
	// decoratedSet));
	// assertTrue(Iterables.elementsEqual(Arrays.asList("Before3", "After", "Before2", "Before1", "Final"),
	// ordered));
	//
	// ordered.remove("Before3");
	// assertTrue(Iterables.elementsEqual(Arrays.asList("Before1", "Before2", "After", "Final"), decoratedSet));
	// assertTrue(Iterables.elementsEqual(Arrays.asList("After", "Before2", "Before1", "Final"), ordered));
    }
	...
	ordered.setSubsetComparator(ExtensionalComparator.create(Arrays
		.asList("Before3", "Before2", "Before1", "Final")));
    }
}
