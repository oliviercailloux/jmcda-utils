 ...
 * </p>
 * <p>
 * Objects of this type are immutable <b>iff</b> the underlying objects are immutable. This object is designed for use
 * with immutable underlying objects, and methods using this class may assume it is immutable.
 * </p>
 * 
...
public class Edge<V> {
    ...
    /**
     * <p>
     * Retrieves a function which, given an edge, gives its string form in the form of the transformation of the first
     * element using the given function, a comma to separate them, and the transformation of the second element,
     * surrounded by less than and greater than signs (to indicate a tuple). No <code>null</code> pairs are accepted by
     * the function, but the elements themselves may be <code>null</code> iff the given transformation functions accept
     * those.
     * </p>
     * <p>
     * This provides an easy way to get short debug strings. E.g. to get a string representing the contents of a set of
     * pairs of alternatives <em>s</em>, use
