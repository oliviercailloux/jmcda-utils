...
public class GraphExporter {
     ...
     * 
     *         Provides automatic ids to vertices: integers from zero to the number of vertices.
     * @param <V>
     *            the vertex type.
     */
    ...
    /**
     * <p>
     * An edge in a directed graph. Can also be viewed as a directed pair. None of the elements of the pair may be
     * <code>null</code>. Note that this object represents an ordered pair, or a 2-tuple, which is different than an
     * unordered pair or <em>couple</em> in French.
     * </p>
     * <p>
     * Objects of this type are immutable <b>iff</b> the underlying objects are immutable. This object is designed for
     * use with immutable underlying objects, and methods using this class may assume it is immutable.
     * </p>
     * 
     * @author Olivier Cailloux
     * 
	...
	public String toString() {
	    ...
	    // return getToStringFunction(Functions.toStringFunction(), Functions.toStringFunction()).apply(this);
	}

	/**
	 * <p>
	 * Retrieves a function which, given an edge, gives its string form in the form of the transformation of the
	 * first element using the given function, a comma to separate them, and the transformation of the second
	 * element, surrounded by less than and greater than signs (to indicate a tuple). No <code>null</code> pairs are
	 * accepted by the function, but the elements themselves may be <code>null</code> iff the given transformation
    ...
    /**
     * <P>
     * Converts the source characters, which must be in DOT format, to an SVG stream.
     * </P>
     * <P>
     * Example use: <code>
     ...
     * 
     * @param from
     *            a stream in DOT format. Not <code>null</code>.
     * @param to
     *            the sink that will receive the SVG output. Not <code>null</code>.
     * @throws IOException
    ...
    /**
     * <P>
     * Exports a jgrapht-like graph to an SVG picture. This goes through dot exporting. To save to a file, use
     * <code>Files.asCharSink(new File(filename), Charsets.US_ASCII)</code>.
     * </P>
     * <P>
     * The <code>vertexNamer</code> will be used to name the vertices. The default is to call {@link #toString()} on
     * vertices.
     * </P>
     * 
     * @param from
     ...
     *             if an I/O error occurs.
     * @throws InterruptedException
     *             if the current thread is interrupted by another thread while it is waiting for the dot export to
     *             proceed.
    ...
    /**
     * @param vertexNamer
     *            set to <code>null</code> to restore default behavior.
     */
