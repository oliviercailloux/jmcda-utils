...
/**
 * TODO replace the Edge by Edge, which can't have <code>null</code> elements, and has source and target.
 * 
...
public class DiGraphImpl<V> implements DiGraph<V> {
	...
	final DiGraphImpl<V> g = new DiGraphImpl<V>(new DefaultDirectedGraph<V, Edge<V>>(
		new GraphUtils.SimpleEdgeFactory<V>()));
