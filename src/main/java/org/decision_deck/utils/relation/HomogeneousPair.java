...
/**
 * An extension of a pair, usable in case the pair is homogeneous. Adds
 * iteration functionality over the two elements constituting the pair.
 * 
 * @author Olivier Cailloux
 * 
 * @param <E> the type of the elements constituting the pair.
 */
