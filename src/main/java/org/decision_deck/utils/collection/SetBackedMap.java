 ...
 * @see <a href=
 *      "http://stackoverflow.com/questions/3869258/guava-setk-functionk-v-mapk-v">stackoverflow</a>
 * 
 * @param <K> the type of the keys to use in this map and in the backing set.
...
public class SetBackedMap<K, V> extends AbstractMap<K, V> {
	...
	static public <K, V> SetBackedMap<K, V> create(Set<K> keys, Function<? super K, ? extends V> funk) {
