...
public class CollectionUtils {
    ...
    /**
     * <p>
     * Creates a new total order defined on the given source set of elements. The order reflects iteration order. The
     * returned order contains all the elements in the given source. A defensive copy is made, so changing the source
     * content afterwards has no effect on the returned order.
     * </p>
     * <p>
     ...
     * 
     * @param <E>
     *            the type of elements this order contains.
     * @param source
     *            not <code>null</code>, may not contain duplicates.
	...
	/**
	 * <p>
	 * Retrieves a function which, given a pair, gives its string form in the form of the transformation of the
	 * first element using the given function, a comma to separate them, and the transformation of the second
	 * element, surrounded by angle brackets (to indicate a tuple). No <code>null</code> pairs are accepted by the
	 * function.
	 * </p>
	 * <p>
	 * This provides an easy way to get short debug strings. E.g. to get a string representing the contents of a set
	 * of pairs of alternatives <em>s</em>, use
	 ...
	 * @param toString1
	 *            a function which transforms the first element of a pair to a string.
	 * @param toString2
	 *            a function which transforms the second element of a pair to a string.
	 * 
	 * @return not <code>null</code>.
	 */
	...
	public String toString() {
	    final Function<Entry<K, V>, String> toStringFunction = getToStringFunction(
     ...
     * "s3", and the contained object contains "s1", "s3", this method returns <code>true</code>. If the contained
     * object contains "s3", "s1", this method returns <code>false</code>. If the contained object is not a subset of
     * the contained object, this method returns <code>false</code>.
     * 
     * @param <T>
     *            the type of searched objects.
     * @param container
     *            not <code>null</code>.
     * @param contained
     *            not <code>null</code>.
     * @return <code>true</code> iff the given container contains every elements of contained in the same order (and
     *         possibly more).
     */
     ...
     * @param sets
     *            not <code>null</code>, no <code>null</code> sets inside.
     * @return not <code>null</code>.
     */
     ...
     * contiguously in the super set. This is a stronger property than {@link #containsInOrder}.
     * 
     * @param <T>
    ...
    /**
     * Retrieves a new empty navigable set using the given comparator. The returned set may be used only on objects
     * known by the comparator, which is probably not the whole set of objects of type <em>E</em> as the given
     * comparator is a subset comparator.
     * 
    ...
    /**
     * If the given iterable contains a unique element, possibly repeated, this method returns that element, more
     * precisely, the first one of all the equal elements. If the given iterable contains at least two different (as per
     * equals) elements, the method returns <code>null</code>. If the given iterable is empty, this method returns
     * <code>null</code>. If the given iterable contains only <code>null</code> elements, this method returns
     * <code>null</code>.
     * 
     * @param iterable
     *            not <code>null</code>.
