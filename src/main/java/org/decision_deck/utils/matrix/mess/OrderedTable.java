...
public class OrderedTable<R, C, V> extends ForwardingTable<R, C, V> implements Table<R, C, V> {
	 ...
	 * 
	 * <p>
	 * Iteration order is the order of the delegate and does not take the order
	 * defined in this object into account. The underlying table should provide
	 * guarantees of iteration order, otherwise the implementation in correct order
	 * would be very inefficient. (To do: ask Google.)
	 * </p>
	 * <p>
	 * To do: override remove (and iterator remove), currently broken because does
	 * not remove the object in the order.
	 * </p>
	 */
	@Override
	 ...
	 * {@inheritDoc}
	 * <p>
	 * Uses the delegate iteration order. Making the returned map use the order set
	 * in this object is not implemented, but could be in the future.
	 * </p>
	 * <p>
	 * To do: override remove (and iterator remove), currently broken because does
	 * not remove the object in the order.
	 ...
	 * {@inheritDoc}
	 * <p>
	 * Uses the iteration order set in this object. Changing the iteration order in
	 * this object also changes the iteration order of the returned view.
	 * </p>
	 */
	@Override
	 ...
	 * </p>
	 * <p>
	 * TODO override remove (and iterator remove), currently broken because does not
	 * remove the object in the order.
	 * </p>
	 */
	@Override
	 ...
	 * <p>
	 * Iteration order is the order of the delegate and does not take the order
	 * defined in this object into account.
	 * </p>
	 * <p>
	 * To do: override remove (and iterator remove), currently broken because does
	 * not remove the object in the order.
