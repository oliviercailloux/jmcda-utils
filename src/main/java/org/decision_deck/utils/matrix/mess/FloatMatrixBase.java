...
public class FloatMatrixBase<R, C> implements SparseMatrixDRead<R, C> {
    ...
    /**
     * @param predicate
     *            <code>null</code> for always <code>true</code>.
     */
    ...
    /**
     * Associates the specified value with the specified keys. If this object already contained a mapping for those
     * keys, the old value is replaced with the specified value.
     * 
     * @param row
	...
	/**
	 * Providing a read-write table would be hard, we would also have to wrap possible removals from the maps, maps
	 * iterators, cell set iterator...
	 */
