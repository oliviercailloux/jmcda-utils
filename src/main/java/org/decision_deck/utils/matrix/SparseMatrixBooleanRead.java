 ...
 * this matrix has <code>null</code> entries associated to some positions, which
...
public interface SparseMatrixBooleanRead<R, C> extends SparseMatrixFuzzyRead<R, C> {
	 ...
	 * {@inheritDoc}
	 * 
	 * @return the double value at that position, exactly equal to <code>1d</code>
	 *         to indicate <code>true</code> or <code>0d</code> to indicate
