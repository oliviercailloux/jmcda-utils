...
public class SparseMatrixBooleanImpl<R, C> extends ForwardingSparseMatrix<R, C> implements SparseMatrixD<R, C>,
	SparseMatrixBooleanRead<R, C> {
	...
	super(new ValidatingDecoratedMatrix<R, C>(delegate, Predicates.or(Predicates.equalTo(Double.valueOf(0d)),
		Predicates.equalTo(Double.valueOf(1d)))));
    }
	...
	super(Matrixes.<R, C> newValidating(Predicates.or(Predicates.equalTo(Double.valueOf(0d)),
		Predicates.equalTo(Double.valueOf(1d)))));
    }
