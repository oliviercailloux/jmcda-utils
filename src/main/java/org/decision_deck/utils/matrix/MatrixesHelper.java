...
/**
 * Contains helper methods for dealing with matrixes. Contrary to
 * {@link Matrixes}, this class must be instanciated and provided with a
 * factory.
 * 
 * @author Olivier Cailloux
 * 
 * @param <R> the row type of the matrixes that this instance will work with.
 * @param <C> the column type of the matrixes that this instance will work with.
 */
