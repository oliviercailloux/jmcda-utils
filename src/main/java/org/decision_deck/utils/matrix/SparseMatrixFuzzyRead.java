...
/**
 * <P>
 * A matrix which is able to retrieve values in [0, 1], i.e., doubles between 0
 * and 1 inclusive, at a set of positions, each position being represented by a
 * row and a column entries.
 * </P>
 * <P>
