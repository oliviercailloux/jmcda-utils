 ...
 * column. Note that any values, including special double values such as {@link Double#POSITIVE_INFINITY}, are accepted.
 * </P>
 * <P>
...
public interface SparseMatrixD<R, C> extends SparseMatrixDRead<R, C> {
     ...
     * @return the value previously associated with the keys, or {@code null} if no mapping existed for the keys
     */
     ...
     * @param row
     *            not <code>null</code>.
     * @return <code>true</code> iff there was at least one value at the given row, or equivalently, <code>true</code>
     *         iff the matrix has been modified, or equivalently, <code>true</code> iff {@link #getRows()} reported that
     *         this row existed before calling this method.
     */
