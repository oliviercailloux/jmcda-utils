...
public class ValidatingDecoratedMatrix<R, C> extends ForwardingSparseMatrix<R, C> implements SparseMatrixD<R, C> {
    ...
    /**
     * Retrieves the predicate used in this object. Every value in this matrix satisfies the returned predicate.
     * 
    ...
    /**
     * <p>
     * Creates a new matrix decorating the given matrix by ensuring every element it contains satisfy the given
     * predicate.
     * <p>
     * <p>
     ...
     * 
     * @param value
     *            a double value satisfying the predicate this object uses.
     * @throws IllegalArgumentException
     *             iff the value does not satisfy the predicate used by this object.
     */
    @Override
    public Double put(R row, C column, double value) {
	checkArgument(m_valuePredicate.apply(Double.valueOf(value)), "Invalid value at row " + row + ", column "
		+ column + ": " + value + ".");
